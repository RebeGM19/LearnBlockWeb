    ...
    try {
        for (var h = 0; h < e; h++) {
            ...
            if ("block" == l || !LearnBlock.Events.recordUndo) {
                ...
                if ("variables" == l) {
                    LearnBlock.Xml.domToVariables(k, b);
                    g = !1
                }
            }
        }
...
LearnBlock.WorkspaceDragSurfaceSvg.prototype.getSurfaceTranslation = function () {
    globalTranslateX = LearnBlock.utils.getRelativeXY(this.SVG_).x;
    globalTranslateY = LearnBlock.utils.getRelativeXY(this.SVG_).y;
